...
AbsenceCheckTestTableName = Class.new(ActiveRecord::Base) do
  self.table_name = :table_name
end

describe "absence validation in check constraint begaviour" do
    ...
    Class.new(::ActiveRecord::Migration[5.0]) do
      def change
        create_table :table_name, id: false do |t|
          t.string :absence, validates: { absence: { allow_nil: true, as: :check } }
        end
      end
  ...
  subject(:insert) { AbsenceCheckTestTableName.create! opts }
